      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Dheeraj</span>
            </Link>
            <p className="text-sm text-gray-400">
              Senior Full Stack Software Engineer specializing in cloud-native,
              scalable, and AI-driven applications.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="mailto:dheerajkom2804@gmail.com"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                >
                  <Mail className="w-4 h-4" />
                  dheerajkom2804@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Sri Hari Dheeraj Kommineni. All rights reserved.
            </p>
